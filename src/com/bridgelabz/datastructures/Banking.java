...
import com.bridgelabz.util.QueueBanking;
...
public class Banking {
	...
	public static void main(String[] args) {
		...
		QueueBanking<Integer> d = new QueueBanking<Integer>();
		while (d.capacity > 0) {
			d.enque(d.capacity);
			System.out.println();
			...
			int answer = Functionalprogram.getInputInteger();
			switch (answer) {
			case 1:
				System.out.println("How much do you want to deposit? ");
				amount =Functionalprogram.getInputDoubleModel();
