...
public class TicTac
{
   ...
   public static void main(String[] args) {
	...
	while(true) {
		...
		move = Functionalprogram.computer_move(board);
	    ...
	    // if game is over
	    winner = Functionalprogram.checkWinner(board);
...
System.out.print(Functionalprogram.printChar(board[0][0]));
System.out.print("|");
System.out.print(Functionalprogram.printChar(board[0][1]));
System.out.print("|");
System.out.println(Functionalprogram.printChar(board[0][2]));
System.out.println("-----");
System.out.print(Functionalprogram.printChar(board[1][0]));
System.out.print("|");
System.out.print(Functionalprogram.printChar(board[1][1]));
System.out.print("|");
System.out.println(Functionalprogram.printChar(board[1][2]));
System.out.println("-----");
System.out.print(Functionalprogram.printChar(board[2][0]));
System.out.print("|");
System.out.print(Functionalprogram.printChar(board[2][1]));
System.out.print("|");
System.out.println(Functionalprogram.printChar(board[2][2]));
}
